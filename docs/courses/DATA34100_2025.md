...
- [Slides](https://1drv.ms/p/c/6bd72f353d65b7b8/IQDMIQZRX68HSryUGaXRDzeiAcnIHGPKEFc1qf-NkVlivVM?e=e8RIsJ)
- [layout.zip](https://1drv.ms/u/c/6bd72f353d65b7b8/IQDFKdILuad4TZibwJBAMewYAQE8uAMJxOjO2vgoXQJUAtc?e=OYPHNJ) -- Play with layout algebra in CuTe without a GPU (works on Macbook).
...
- [Slides](https://1drv.ms/p/c/6bd72f353d65b7b8/IQAZTcKW4jqWQpPUF9SWXQOgAWJsY1mJ72rFjHugX4kYwMo?e=RLHyqM)
...
- [Slides](https://1drv.ms/p/c/6bd72f353d65b7b8/IQADfIffv0TqRrFAb-yJ7gx2Ab3ikMujMJAi8RPhKYwnPPY)
 
### Lecture 5: Other Topics in Database Systems 1 (Jan 21)
- Cool things about databases.
    - Incomplete Information
    - Relational Calculus and Codd Theorem 
- [Slides](https://1drv.ms/p/c/6bd72f353d65b7b8/IQDN5bLOSg4aSpitBr7j5D4tARpK8ogoqfIlXxZYvmwfgzs)
...
- [Slides](https://1drv.ms/p/c/6bd72f353d65b7b8/IQC5YAnMSDx0T7pjc6idSVN0AY2mkyumle4248dnDnuHyMY)
...
**Materials**
- Exercise:
    - [Optimizing single-core GEMM on Macbook to >90% peak flops (matches Accelerate)](https://github.com/zhangce/DATA34100/tree/main/gemm_exercise)
    - [a version that gets 90% peak flops (matches OpenBLAS) on Intel CPUs](https://github.com/zhangce/DATA34100/tree/main/gemm_exercise_intel)
- CPU Microarchitecture: A really great video from Intel about [microarchitecture](https://www.youtube.com/watch?v=o_WXTRS2qTY). 

### Lecture 7: CPU Microarchitecture and Performance Model (Jan 28)
- CPU Microarchitecture and Performance Hazards
- [Slides](https://github.com/zhangce/DATA34100/blob/main/cpu/lecture6_microarchitecture/lecture-cpu-microarchitecture.pdf)
- [Code](https://github.com/zhangce/DATA34100/tree/main/cpu/lecture6_microarchitecture)

### Lecture 8: Instruction-Level Parallelism (Feb 2)
- [Slides](https://github.com/zhangce/DATA34100/blob/main/cpu/lecture7_ilp/lecture-ilp.pdf)
- [Code](https://github.com/zhangce/DATA34100/tree/main/cpu/lecture7_ilp)

### Lecture 9: SIMD (Feb 4)
- [Slides](https://github.com/zhangce/DATA34100/blob/main/cpu/lecture8_simd/lecture-simd.pdf)
- [Code](https://github.com/zhangce/DATA34100/tree/main/cpu/lecture8_simd)

### Lecture 10: Locality, Caches, Blocking (Feb 9)
- [Slides](https://github.com/zhangce/DATA34100/blob/main/cpu/lecture9_locality/lecture-locality-cache.pdf)
- [Code](https://github.com/zhangce/DATA34100/tree/main/cpu/lecture9_locality)

### Lecture 11: Roofline (Feb 11)
- [Slides](https://github.com/zhangce/DATA34100/blob/main/cpu/lecture10_roofline/lecture-roofline.pdf)
- [Code](https://github.com/zhangce/DATA34100/tree/main/cpu/lecture10_roofline)

### Lecture 12: GEMM (Feb 16)
- Hands on -- 80% Accelerate
- [Code](https://github.com/zhangce/DATA34100/blob/main/gemm.zip)

### Lecture 13: GEMM (Feb 19)
- [Reading](https://arxiv.org/html/2512.21473v1)
   - Compare this with what we produced on Monday (specifically, look at blocking strategy and loop order)
   - How does it help to remove the packing overhead as we identified on Monday (it was 20% of the time!)
   - Think about all the tricks that are in this paper, but we haven't tried on Monday

### Lecture 14: GEMM (Feb 23)
- Hands on -- >99% Accelerate!
- [Code](https://github.com/zhangce/DATA34100/blob/main/gemm_2.zip)
...
### Lecture 15: Generative Data Model — Tokens and Transformers (Feb 25)
- [Slides](https://github.com/zhangce/DATA34100/blob/main/llms/Lecture%2015.%20LLMs.pdf)

### Lecture 16: A Very Shallow Dive on GPUs (March 2)
- [Slides](https://github.com/zhangce/DATA34100/tree/main/cpu/lecture16_gpu/lecture-gpu-programming.pdf)
