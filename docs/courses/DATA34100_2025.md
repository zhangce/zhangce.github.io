...
- Cool things about databases.
    - Optimizer -- Cardinality Estimation, etc.  
...
**Materials**
- Exercise: [Optimizing single-core GEMM on Macbook to >90% peak flops (matches Accelerate)](https://github.com/zhangce/DATA34100/tree/main/gemm_exercise) | [a version that gets 90% peak flops (matches OpenBLAS) on Intel CPUs](https://github.com/zhangce/DATA34100/tree/main/gemm_exercise_intel)
- CPU Microarchitecture: A really great video from Intel about [microarchitecture](https://www.youtube.com/watch?v=o_WXTRS2qTY). 

### Lecture 6: CPU Microarchitecture and Performance Model (Jan 26)

### Lecture 7: Benchmarking and Instruction-Level Parallelism (Jan 28)

### Lecture 8: SIMD (Feb 2)

### Lecture 9: Locality, Caches, Blocking (Feb 4)

### Lecture 10: GEMM (Feb 9)
...
### Lecture 12: Generative Data Model — Tokens and Transformers (Feb 16)

### Lecture 13: Performance Model and Tile-Based Programming Model (Feb 18)

### Lecture 14: Kernel: GEMM (Feb 23)

### Lecture 15: Inference Systems — Beyond Kernels (Feb 25)
...
### Lecture 17: Data Systems — The Last Ten Years and the Next Ten (March 2)
